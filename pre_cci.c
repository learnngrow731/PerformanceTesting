# 1 "e:\\loadrunner practice\\scripts\\firstscript_baseline\\\\combined_FirstScript_Baseline.c"
...
# 1 "e:\\loadrunner practice\\scripts\\firstscript_baseline\\\\combined_FirstScript_Baseline.c" 2
...
# 2 "e:\\loadrunner practice\\scripts\\firstscript_baseline\\\\combined_FirstScript_Baseline.c" 2
...
# 3 "e:\\loadrunner practice\\scripts\\firstscript_baseline\\\\combined_FirstScript_Baseline.c" 2
...
# 4 "e:\\loadrunner practice\\scripts\\firstscript_baseline\\\\combined_FirstScript_Baseline.c" 2
...
Action()
{
	...
	lr_end_transaction("00_Launch", 2);
	...
	lr_end_transaction(lr_eval_string("02_SelectCatagory_{CatagoryName}" ),2);
	...
	lr_end_transaction(lr_eval_string("03_Select_{CatagoryName}_{CatagoryID}" ),2);
	...
	lr_end_transaction(lr_eval_string("04_AddToCard_for {CatagoryName}_{ItemID}"),2);
	...
	lr_end_transaction("05_proceedTo checkout",2);
	...
	lr_end_transaction("06_Payment_Continue",2);
	...
	lr_end_transaction("07_confirm",2);
	...
	lr_end_transaction("08_SignOUT",2);

	return 0;
}
# 5 "e:\\loadrunner practice\\scripts\\firstscript_baseline\\\\combined_FirstScript_Baseline.c" 2
...
# 6 "e:\\loadrunner practice\\scripts\\firstscript_baseline\\\\combined_FirstScript_Baseline.c" 2
